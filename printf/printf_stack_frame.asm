...
str_example db "Here are numbers %u %x %b Hello\n I %s %x %u %% %c !! %b $"
str_1 db "love$"
...
my_printf			proc
					...
					pop bp                     ; ret address in BP
					
					pop bx                     ; offset is in BX
...
@@Exit:				push bp   ; return addres is in stack
					ret
					endp
